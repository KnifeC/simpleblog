...
public class PermissionIntercepter implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (request.getRequestURI().equals("/admin")||request.getRequestURI().equals("/image")||request.getRequestURI().equals("/edit") || request.getRequestURI().equals("/write") || request.getRequestURI().equals("/edit/**") || request.getRequestURI().equals("/deletearticle/**")) {
